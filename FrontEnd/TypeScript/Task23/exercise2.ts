...
export default () => {
  ...
  // [/do not edit]
  interface CityCoords extends City {
    coords: Coords
  }

  const montreal :CityCoords ={
    coords: {
      latitude: 42.332,
      longitude: -73.324,
    },
  ...
  function getCityInfo(city: CityCoords) {
  ...
  // user.id = 5; // not writable   Cannot assign to 'id' because it is a read-only property.
